...
uri = config.sandbox.endpoint + "/launchRequests.json?api_key=#{@invalid_api_key}&launch_key=5c18c7"
...
uri = config.production.endpoint + "/launchRequests.json?api_key=#{@api_key}&launch_key=5c18c7";
